...
function Hero(){
    return (
            ...
            <div className="xl: max-w-[1240px] w-full mx-auto text-center flex items-center flex-col justify-center text-white">
               ...
               <h4 className="md:text-5xl sm:text-5xl font-bold text-yellow"> Customized Finance Teams</h4>
               <div className='flex row-auto justify-center items-center mt-8'>  
                ...
                <Link className='bg-white text-slate font-medium w-[200px] rounded-lg my-6 py-1 motion-safe:hover:-translate-x-1 hover:bg-yellow motion-safe:transition ' to={'/contact'}> Get Started</Link>
            </div>
